...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2025 at 04:10 PM
...
--
-- Constraints for table `professors_gradingsys`
--
ALTER TABLE `professors_gradingsys`
  ADD CONSTRAINT `professors_gradingsys_ibfk_1` FOREIGN KEY (`prof_id`) REFERENCES `admin_users` (`admin_id`);
--
-- Database: `phpmyadmin`
--
